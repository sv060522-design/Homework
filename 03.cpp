...
public:
    DraggableWithColorChange(Vector2 position, Vector2 size, Color baseColor, Color dragColor)
        : Draggable(position, size, baseColor), mBaseColor(baseColor), mDragColor(dragColor), mColorChanged(false)
    {
    }
...
int main()
{
    InitWindow(800, 600, "DraggableWithColorChange Test");
    SetTargetFPS(100);

    DraggableWithColorChange d {{100, 100}, {200, 400}, {80, 80, 120, 255}, {255, 0, 0, 255}};
